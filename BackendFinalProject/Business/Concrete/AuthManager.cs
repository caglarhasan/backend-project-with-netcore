...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IResult UserExists(string email)
        {
            ...
            {
                return new ErrorResult(Messages.UserAlreadyExists); // Kullanıcı zaten oluşturulmuş.
            }
        ...
        public IDataResult<AccessToken> CreateAccessToken(User user)
        {
            ...
            return new SuccessDataResult<AccessToken>(accessToken, Messages.AccessTokenCreated); // Token oluşturuldu.
        }
    }
}
